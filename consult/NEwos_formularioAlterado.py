...
class OrdemServicoFormulario(UserControl):
    ...
    def criar_modal_ordem_servico(self):
        """Cria e retorna o AlertDialog para a Ordem de Serviço."""
